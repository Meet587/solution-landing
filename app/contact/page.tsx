...
export const metadata: Metadata = {
  ...
  description:
    "Discuss your private AI deployment, data security, and architectural needs with our team.",
};
      ...
      <div className="section-container max-w-5xl">
        ...
        <div className="mb-20 animate-fade-in-up">
          ...
          <p className="text-xl text-foreground-secondary max-w-2xl leading-relaxed">
            Discuss your use case, deployment model, and data environment with
            our team.
        ...
        <div
          className="grid md:grid-cols-12 gap-12 mb-24 animate-fade-in-up"
        ...
        >
          ...
          <div className="md:col-span-8 lg:col-span-9">
            <div className="bg-background-surface border border-border rounded-lg p-8">
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-sm text-foreground-secondary">
                    We skip qualification questions and generic demos. You'll
                    speak directly with solutions engineers who understand
                    infrastructure.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-foreground-secondary">
                    We focus on architecture and technical feasibility first.
                    This call is for serious AI deployments.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div
          className="grid md:grid-cols-2 gap-12 mb-24 animate-fade-in-up"
        ...
        <div
          className="max-w-3xl border-t border-border pt-16 mb-24 animate-fade-in-up"
          style={{ animationDelay: "300ms" }}
        >
          <div className="mb-10">
            <h2 className="text-2xl font-bold mb-2">Start the Conversation</h2>
            <p className="text-foreground-secondary">
              Tell us about your architectural needs. Your information stays
              private.
            </p>
          </div>
        ...
        <div
          className="grid md:grid-cols-2 gap-12 border-t border-border pt-16 animate-fade-in-up"
        ...
        >
          ...
          <div>
            ...
            <a
              href="mailto:enterprise@meet.ai"
              className="flex items-center gap-3 text-foreground hover:text-primary transition-colors group"
            >
              <div className="p-2 bg-background-surface rounded-md group-hover:bg-primary/10 transition-colors">
            ...
            <p className="mt-4 text-sm text-foreground-muted">
              For existing enterprise partners, please contact your dedicated
              solutions architect directly.
            </p>
          </div>
